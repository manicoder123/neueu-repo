...
const socialsData = [
  {
    icon: <FaInstagram />,
    link: "https://www.instagram.com/neueumedical?igsh=cm93NXJvajNxenl2",
  },
  {
    icon: <CiFacebook />,
    link: "https://www.facebook.com/profile.php?id=61566649072474&mibextid=wwXIfr&rdid=OVrmXSbYKrpxHm5A&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F1BTkikvoWx%2F%3Fmibextid%3DwwXIfr",
  },
    ...
    <div className="grid lg:grid-cols-3 grid-cols-1">
      ...
      <div className="flex flex-col justify-center text-white 2xl:gap-10 gap-5 text-center items-center">
        ...
        >
          ...
          <button
            onClick={() =>
              router.push("https://offer.neueu.co/freeconsultation")
            }
            className="md:px-10 px-7 ml-auto md:py-3 py-2 relative z-20 rounded-full text-primary bg-white font-semibold cursor-pointer"
          >
            Subscribe
          </button>
        </motion.div>
